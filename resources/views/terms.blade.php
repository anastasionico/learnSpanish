...
@section('contentOne')
    <div class="row  p-5 text-left bg-grayLight">
        ...
        <div class="col-sm-12 col-lg-8 p-5 rounded bg-white">
            ...
            <li>engaging in any data mining, data harvesting, data extracting or any other similar activity in relation to this Website;
            ...
            <h2 class="c-greenLight">Your Content</h2>
            ...
            <h2 class="c-greenLight">No warranties</h2>
            ...
            <h2 class="c-greenLight">Limitation of liability</h2>
            ...
            <h2 class="c-greenLight">Indemnification</h2>
            ...
            <h2 class="c-greenLight">Severability</h2>
            <p>If any provision of these Terms is found to be invalid under any applicable law, such provisions shall be deleted without affecting the remaining provisions herein.</p>
            <h2 class="c-greenLight">Variation of Terms</h2>
            ...
            <h2 class="c-greenLight">Assignment</h2>
            ...
            <h2 class="c-greenLight">Entire Agreement</h2>
            ...
            <h2 class="c-greenLight">Governing Law & Jurisdiction</h2>
